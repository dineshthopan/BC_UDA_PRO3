App = {
    ...
    handleButtonClick: async function(event) {
        ...
        switch(processId) {
            ...
            case 10:
                ...
                break;
            case 11:
                return await App.setActors(event);
                break;
            }
    },
    ...
    sellItem: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            const productPrice = web3.toWei(App.productPrice.toString(), "ether");
    ...
    buyItem: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            const walletValue = web3.toWei("0.0000002", "ether");
    ...
    setActors: function () {
        App.contracts.SupplyChain.deployed().then(function (instance) {
            ...
            $("#ftc-item").text(result);
            console.log('setActors::addFarmer:: ', result);
        }).catch(function (err) {
            console.log(err.message);
        });
        ...
        App.contracts.SupplyChain.deployed().then(function (instance) {
            ...
            $("#ftc-item").text(result);
            console.log('setActors::addDistributor:: ', result);
        }).catch(function (err) {
            console.log(err.message);
        });
        ...
        App.contracts.SupplyChain.deployed().then(function (instance) {
            ...
            $("#ftc-item").text(result);
            console.log('setActors::addRetailer:: ', result);
        }).catch(function (err) {
            console.log(err.message);
        });
        ...
        App.contracts.SupplyChain.deployed().then(function (instance) {
            ...
            $("#ftc-item").text(result);
            console.log('setActors::addConsumer:: ', result);
        }).catch(function (err) {
            console.log(err.message);
        });
    },
